...
{
    public partial class UserChangeAnswer : Form
    {
        public Point mouseLocation;
        private String username;
        public UserChangeAnswer()
        {
            InitializeComponent();
        }
        public UserChangeAnswer(String username)
        {
            InitializeComponent();
        ...
        private void btnUpdateAnswer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string code = "SELECT RA_ANSWER FROM RESIDENT_ACCOUNT WHERE RA_USERNAME=N'" + username + "'";
                    ...
                    try
                    {
                        ...
                        if (reader.HasRows)
                        {
                            ...
                            string r_answer = reader["RA_ANSWER"].ToString();

                            clsDatabase.CloseConnection();

                            if (r_answer.Equals(oldanswer))
                            {
                                string query = "UPDATE RESIDENT_ACCOUNT SET RA_ANSWER=N'" + newanswer + "' WHERE RA_USERNAME=N'" + username + "'";
