...
{
    public partial class StaffAccountInformation : Form
    {
        ...
        public StaffAccountInformation()
        {
            InitializeComponent();
            BindingData();
        }

        public StaffAccountInformation(string username)
        {
            InitializeComponent();
            BindingData();
                                ...
                                try
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        string code2 = "UPDATE S  SET S.STAFF_NAME=N'" +
                                            ...
                                            job + "' FROM STAFF AS S JOIN STAFF_ACCOUNT AS SA ON S.STAFF_ID=SA.SA_STAFF WHERE SA.SA_USERNAME='" + username + "'";
        ...
        {
            StaffHomePage adminHomePage = new StaffHomePage(username);
            this.Hide();
