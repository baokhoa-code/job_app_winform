...
{
    public partial class AdminChangeAnswer : Form
    {
        public Point mouseLocation;
        private String username;
        public AdminChangeAnswer()
        {
            InitializeComponent();
        }
        public AdminChangeAnswer(String username)
        {
            InitializeComponent();
        ...
        private void btnUpdateAnswer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string code = "SELECT AA_ANSWER FROM ADMIN_ACCOUNT WHERE AA_USERNAME=N'" + username + "'";
                    ...
                    try
                    {
                        ...
                        if (reader.HasRows)
                        {
                            ...
                            string r_answer = reader["AA_ANSWER"].ToString();

                            clsDatabase.CloseConnection();

                            if (r_answer.Equals(oldanswer))
                            {
                                string query = "UPDATE ADMIN_ACCOUNT SET AA_ANSWER=N'" + newanswer + "' WHERE AA_USERNAME=N'" + username + "'";
