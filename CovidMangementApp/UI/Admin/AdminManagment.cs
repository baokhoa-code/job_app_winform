...
namespace CovidMangementApp.UI.Admin
{
    public partial class AdminManagment : Form
    {
        ...
        public AdminManagment(String username)
        {
            InitializeComponent();
        ...
        private void BindingAdminList()
        {
            ...
            string code = "SELECT * FROM ADMIN_ACCOUNT JOIN ADMIN ON ADMIN_ACCOUNT.AA_ADMIN = ADMIN.ADMIN_ID";
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        table.Rows.Add(
                            reader["AA_USERNAME"].ToString(),
                            reader["ADMIN_NAME"].ToString(),
                            reader["ADMIN_PHONE"].ToString(),
                ...
                {
                    Notification notification = new Notification("Danh sách Admin trống");
                    notification.ShowDialog();
                    return;
                }
                clsDatabase.CloseConnection();
        ...
        private void btnOpenAdd_Click(object sender, EventArgs e)
        {
            ...
            string code = "SELECT MAX(AA_ORDER) CODE FROM ADMIN_ACCOUNT";
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    try
                    {
                        ...
                        number++;
                        if (number < 10)
                            id = "admin0000" + number.ToString();
                        else if (number < 100)
                            id = "admin000" + number.ToString();
                        else if (number < 1000)
                            id = "admin00" + number.ToString();
                        else if (number < 10000)
                            id = "admin0" + number.ToString();
                        else
                            id = "admin" + number.ToString();
                    }
                    catch (Exception ex)
                    {
                        id = "admin00001";
                ...
                if (Regex.IsMatch(fullname, @"^[A-Z ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪỬỮỰỲỴÝỶỸ]+$") && fullname.Length <= 100)
                {
                    if (Regex.IsMatch(phone, @"^[0-9]+$") && phone.Length == 10)
                    {
                        if (Regex.IsMatch(cmnd, @"^[a-zA-Z0-9]+$") && cmnd.Length <= 20)
                        {
                            ...
                            {
                                string code = "SELECT ADMIN_PHONE FROM ADMIN WHERE ADMIN_ID='" + cmnd + "'";
                                    ...
                                    else
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                string code2 = "INSERT INTO ADMIN VALUES (N'" +
                                                    fullname + "',N'" +
                                                    dob + "',N'" +
                                                    sex + "',N'" +
                                                    cmnd + "',N'" +
                                                ...
                                                string code3 = "INSERT INTO ADMIN_ACCOUNT(AA_USERNAME,AA_PASSWORD,AA_ADMIN,AA_ANSWER) VALUES ('"
                                                ...
                                                string result = "Bạn đã đăng ký thành công tài khoản quản trị viên. Hãy đăng nhập với tên đăng nhập là '" + adminname + "' và mật khẩu là '" + adminname + "'.";
        ...
        private void gridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (e.ColumnIndex == gridView.Columns["Xóa"].Index)
                {
                    ...
                    string code = "SELECT * FROM ADMIN JOIN ADMIN_ACCOUNT ON ADMIN.ADMIN_ID = ADMIN_ACCOUNT.AA_ADMIN WHERE AA_USERNAME= '" + usernameReal + "'";
                    ...
                    try
                    {
                        ...
                        if (reader.HasRows)
                        {
                            ...
                            {
                                string code2 = "DELETE FROM ADMIN_ACCOUNT WHERE AA_USERNAME = '" + usernameReal + "'";
                                ...
                                try
                                {
                                    ...
                                    string code3 = "DELETE FROM ADMIN WHERE ADMIN_ID = '" + cmnd1 + "'";
                                    ...
                                    try
                                    {
                                        ...
                                        Notification notification3 = new Notification("Đã xóa admin thành công");
                                        notification3.ShowDialog();
                                        clsDatabase.CloseConnection();
                                        BindingAdminList();
                                        return;
                        ...
                        {
                            Notification notification = new Notification("Không tìm thấy admin");
                            notification.ShowDialog();
                            return;
                        }
                        clsDatabase.CloseConnection();
                                ...
                                try
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        string code2 = "UPDATE A  SET A.ADMIN_NAME=N'" +
                                            ...
                                            job + "' FROM ADMIN AS A JOIN ADMIN_ACCOUNT AS AA ON A.ADMIN_ID=AA.AA_ADMIN WHERE AA.AA_USERNAME='" + usernameReal + "'";
                                        ...
                                        try
                                        {
                                            ...
                                            string result = "Thông tin admin đã được cập nhật thành công";
