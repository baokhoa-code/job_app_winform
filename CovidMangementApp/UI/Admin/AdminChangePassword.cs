    ...
    public partial class AdminChangePassword : Form
    {
        ...
        private void btnChangePassword_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string code = "SELECT AA_PASSWORD FROM ADMIN_ACCOUNT WHERE AA_USERNAME=N'" + username + "'";
                    ...
                    try
                    {
                        ...
                        if (reader.HasRows)
                        {
                            ...
                            string r_password = reader["AA_PASSWORD"].ToString();

                            clsDatabase.CloseConnection();

                            if (r_password.Equals(oldpassword))
                            {
                                string query = "UPDATE ADMIN_ACCOUNT SET AA_PASSWORD=N'" + newpassword + "' WHERE AA_USERNAME=N'" + username + "'";
